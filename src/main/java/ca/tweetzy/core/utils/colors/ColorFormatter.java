...
package ca.tweetzy.core.utils.colors;

import ca.tweetzy.core.utils.colors.patterns.GradientColorPattern;
import ca.tweetzy.core.utils.colors.patterns.RainbowColorPattern;
import ca.tweetzy.core.utils.colors.patterns.SolidColorPattern;
...
public final class ColorFormatter {
    ...
    /**
     * Cached result of ColorPatterns.
     *
     * @since 1.0.2
     */
    ...
    public static String process(@Nonnull String string) {
        for (ColorPattern ColorPattern : ColorPatternS) {
            string = ColorPattern.process(string);
        }
